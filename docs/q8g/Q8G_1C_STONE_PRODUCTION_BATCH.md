...
## 4. F8-lite 循环验证（provisional 数据点）

- 10 场 layer-1 普通战斗产出 **30 石** ≥ 首步 promotion 石耗（10）——"战斗收入能供养 promotion"在最小闭环上成立（`test_f8_lite_...` 钉住）；
- 完整校准（材料获取通道接入后的真实跑图收入/支出曲线）归 F8 复跑。
