> 状态说明（2026-09-18）：本文件保留为历史设计记录，不再作为当前实现的开发契约。当前只执行 `ARCHITECTURE.md`、`WORKER_PROTOCOL.md` 与 `config/common.json`；其中 V0.1-V0.5、通用 Agent/Provider 编排和其他未来平台化方向暂停，不在本阶段实现。
