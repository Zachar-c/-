...
# Resolve the Godot console executable exactly like tools/godot.ps1 does.
$candidates = @(@(
...
if ($candidates.Count -eq 0) { throw 'Godot console executable was not found. Set GODOT_CONSOLE_PATH.' }
