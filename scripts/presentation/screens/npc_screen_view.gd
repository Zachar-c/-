...
@onready var _npc_name_label: Label = $Root/HeaderRow/HeaderInner/NpcNameLabel
@onready var _stance_label: Label = $Root/HeaderRow/HeaderInner/StanceLabel
@onready var _stance_note_label: Label = $Root/HeaderRow/HeaderInner/StanceNoteLabel
@onready var _notoriety_label: Label = $Root/HeaderRow/HeaderInner/NotorietyLabel
@onready var _notoriety_note_label: Label = $Root/HeaderRow/HeaderInner/NotorietyNoteLabel
@onready var _trade_panel: PanelContainer = $Root/primary_decision_surface/TradeColumn/TradePanel
@onready var _barter_panel: PanelContainer = $Root/primary_decision_surface/BarterColumn/BarterPanel
