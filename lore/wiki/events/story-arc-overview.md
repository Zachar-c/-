...
| 九 义天山大战 | 225,001–240,000 笔记域 | 骨架＋锚点（春秋蝉 ST-CICADA-07…09） | [春秋蝉](../gu/spring-autumn-cicada.md)转引 |
| 十 逆流河与琅琊 | 225,001–315,000 前段 | 骨架＋事件页 | [逆流河](reverse-flow-river.md)、[天庭入侵琅琊福地](langya-blessed-land-invasion.md) |
| 十一 宿命大战 Run 1 | 270,001–323,421 | 骨架＋事件页 | [宿命大战](fate-war.md) |
| 十二 Run 2 与宿命毁灭 | 323,422–360,000 | 骨架＋锚点 | [石莲岛与红莲真传争夺](stone-lotus-island-contest.md) |
| 十三 三尊博弈与断点 | 360,001–437,061 | 骨架＋锚点（系统补强批） | 本页＋[北原](../world/north-plain.md)疯魔窟条 |
...
覆盖状态：骨架＋锚点——影无邪劫持春秋蝉（弧九收束关键机制）已核，见[春秋蝉](../gu/spring-autumn-cicada.md) ST-CICADA-07…09；大战本体逐事件待 C 线。
...
覆盖状态：骨架＋事件页（fate-war 页已逐段核验 Run 1 收尾与 Run 2 开启）。
...
覆盖状态：骨架＋锚点（石莲岛尽收真传、宿命蛊拆分等已核，见[石莲岛与红莲真传争夺](stone-lotus-island-contest.md)）。
...
覆盖状态：骨架＋锚点（系统补强批已锚定终局链，逐事件待 C 线）。
