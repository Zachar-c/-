...
| C（全书按剧情顺序精蒸馏） | **本轮（按 L0 指令截止第二卷）收口**：狼潮/兽潮簇（WTC，原误标 B 线）✅（benchmark-wtc 50/50）→ 弧三·南疆商队与商家城（CAR 簇）✅（benchmark-car 49.5/50，EVT-CAR-001…044）→ 弧四·仙鹤门方正线与三王福地（TKF 簇）✅（benchmark-tkf 50/50，EVT-TKF-001…032；three-kings-mountain 已重构为弧四枢纽页 v2，节 135–206 全程核验）| events/wolf-tide.md、events/south-caravan.md、events/three-kings-mountain.md、world/beast-tide.md、world/south-jiang.md、events/story-arc-overview.md、qing-mao-mountain 的 WTC 投影行、tools/benchmark-wtc/car/tkf | **三簇全绿（50/49.5/50）；剧情时间线推进至卷二终（段二末节 206 登仙笞凤凰）**；下一轮自弧五·王庭之争（段三 75,384 行起）开新簇 |
