...
| B（全书粗蒸馏，本线） | ROSTER ✅ → GU-ROSTER ✅ → PATH-ROSTER ✅ → DOMAIN ✅ → ECON ✅ → ORG ✅ → THEME ✅ → GAP-SWEEP ✅ → ROSTER-2 ✅ → 地图/杀招/蛊虫二期/敌人（MAP/KM/GU2/ENEMY）✅ → 后续候选：按需维护与跟进核验 | characters/roster+roster-2+enemy-roster、gu/roster+roster-2、world/path-roster+map-roster+kill-move-roster+四域页+economy-roster+四组织页、themes 三页、各分类 index、index.md（Key Findings）、log.md | 十三簇全绿（人物主/次/敌人/蛊虫主/次/流派/杀招/五域/地图/经济/组织/主题/补漏）；粗粒度抽样核验、无 benchmark；rules/ 归 A 线不动 |
| C（全书按剧情顺序精蒸馏） | 狼潮/兽潮簇（WTC，原误标 B 线）✅ → 弧三·南疆商队与商家城（CAR 簇）✅（benchmark-car 49.5/50）→ **弧四·仙鹤门方正线与三王福地（TKF 簇）进行中：标段一＋二＋三（上）已提交（方正线→黑白双煞→犬王传承→三光柱→以一对七→狐仙福地开启→荡魂山地灵→方源主动寻死，EVT-TKF-001…022）；标段三（下）＝定仙游本体、屠戮五转、白凝冰决裂、登仙笞凤凰（节 179–206）** | events/wolf-tide.md、events/south-caravan.md、events/three-kings-mountain.md、world/beast-tide.md、world/south-jiang.md、events/story-arc-overview.md、qing-mao-mountain 的 WTC 投影行 | WTC ✅ 50/50 · CAR ✅ 49.5/50 · TKF 标段一/二/三(上)已提交 |
