...
这是 AI 平时使用的入口。本库按 LLM Wiki 方法论编译：原文与二级资料只读（L0），本目录是持续重构的综合层（L5），层级模型见 [`AGENTS.md`](AGENTS.md)。先看 Key Findings 与分类索引，再沿链接进入具体页面；需要精确原话或处理争议时，回查 [`source/README.md`](source/README.md) 中的原始资料。
...
- [人物](characters/index.md)
- [蛊虫](gu/index.md)
- [事件](events/index.md)
- [世界规则](world/index.md)
- [主题与《人祖传》](themes/index.md)
