...
const BODY_TEXT := {
	...
	"ascension_special": "Every preparation held and the crossing left nothing behind.",
	"ascension_high": "The crossing went well; only a small weight came along.",
	"ascension_medium": "The crossing held together, though gaps in preparation showed.",
	"ascension_low": "The crossing barely held, carried through on luck and stubbornness.",
