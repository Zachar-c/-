...
@onready var _decision_panel: PanelContainer = $primary_decision_surface/RecapGrid/DecisionPanel
@onready var _gains_panel: PanelContainer = $primary_decision_surface/RecapGrid/GainsPanel
@onready var _balance_panel: PanelContainer = $primary_decision_surface/RecapGrid/BalancePanel
@onready var _record_panel: PanelContainer = $primary_decision_surface/RecapGrid/RecordPanel
@onready var _unlock_panel: PanelContainer = $primary_decision_surface/RecapGrid/UnlockPanel
@onready var _aftermath_panel: PanelContainer = $primary_decision_surface/RecapGrid/AftermathPanel
