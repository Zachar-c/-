...
5. **美术素材补齐（2026-09-15 新建待办，两途径）**：缺失清单与提示词见 `docs/art/AI-ART-PROMPTS.md`（§9 开源 vs AI 分类）、`docs/art/BATCH-1-PROMPTS.md`（首轮入库状态速查）。
